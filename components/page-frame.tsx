...
export default function PageFrame({ tone = "light" }: { tone?: "light" | "dark" }) {
  ...
  return (
    ...
    >
      ...
      <div className={`${line} left-0 top-[4rem] h-px w-full`} />
      <div className={`${line} bottom-[4rem] left-0 h-px w-full`} />
      <div className={`${line} left-[4rem] top-0 h-full w-px`} />
      <div className={`${line} right-[4rem] top-0 h-full w-px`} />
    </motion.div>
  );
}
